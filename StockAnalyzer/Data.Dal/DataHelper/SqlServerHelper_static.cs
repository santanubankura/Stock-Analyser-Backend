...
namespace Data.Dal.DataHelper
{
    public partial class SqlServerHelper
    {
        ...
        public static DataSet ExecuteDataSetProc(string StoredProcedureName, params SqlParameter[] commandParameters)
        {
            return ExecuteDataSet(default_connection_str, CommandType.StoredProcedure, StoredProcedureName, commandParameters);
        }
        ...
        internal static void ExecuteNonQueryProc(string v, SqlParameter prmId, SqlParameter prmInspectorType, SqlParameter prmInspectorName, SqlParameter prmMobileNo, SqlParameter prmActive, object isLicence)
        {
            throw new NotImplementedException();
        }

        internal static void ExecuteNonQueryProc(string v, SqlParameter prmId, SqlParameter prmInspectorType, SqlParameter prmInspectorName, SqlParameter prmMobileNo, SqlParameter prmActive, SqlParameter prmIsLicence)
        {
            throw new NotImplementedException();
        }
